...
static const char __pyx_k_home_jczeng_workspace_AppReview[] = "/home/jczeng/workspace/AppReview/src/_lda.pyx";
...
static PyObject *__pyx_kp_s_home_jczeng_workspace_AppReview;
 ...
 */
  ...
  __Pyx_WriteUnraisable("_lda.lgamma", __pyx_clineno, __pyx_lineno, __pyx_filename, 0, 1);
  __pyx_r = 0;
  __pyx_L0:;
  #ifdef WITH_THREAD
  PyGILState_Release(__pyx_gilstate_save);
...
static PyMethodDef __pyx_mdef_4_lda_1_sample_topics = {"_sample_topics", (PyCFunction)__pyx_pw_4_lda_1_sample_topics, METH_VARARGS|METH_KEYWORDS, 0};
  ...
  __Pyx_RefNannySetupContext("_sample_topics (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        case  8:
        if (likely((values[8] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_eta_sum)) != 0)) kw_args--;
        else {
    ...
    __pyx_v_WS = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[0]); if (unlikely(!__pyx_v_WS.memview)) __PYX_ERR(0, 41, __pyx_L3_error)
    __pyx_v_DS = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[1]); if (unlikely(!__pyx_v_DS.memview)) __PYX_ERR(0, 41, __pyx_L3_error)
    __pyx_v_ZS = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[2]); if (unlikely(!__pyx_v_ZS.memview)) __PYX_ERR(0, 41, __pyx_L3_error)
    __pyx_v_nzw = __Pyx_PyObject_to_MemoryviewSlice_dsds_int(values[3]); if (unlikely(!__pyx_v_nzw.memview)) __PYX_ERR(0, 41, __pyx_L3_error)
    __pyx_v_ndz = __Pyx_PyObject_to_MemoryviewSlice_dsds_int(values[4]); if (unlikely(!__pyx_v_ndz.memview)) __PYX_ERR(0, 41, __pyx_L3_error)
    __pyx_v_nz = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[5]); if (unlikely(!__pyx_v_nz.memview)) __PYX_ERR(0, 41, __pyx_L3_error)
    __pyx_v_alpha = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[6]); if (unlikely(!__pyx_v_alpha.memview)) __PYX_ERR(0, 42, __pyx_L3_error)
    __pyx_v_eta = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[7]); if (unlikely(!__pyx_v_eta.memview)) __PYX_ERR(0, 42, __pyx_L3_error)
    __pyx_v_eta_sum = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[8]); if (unlikely(!__pyx_v_eta_sum.memview)) __PYX_ERR(0, 42, __pyx_L3_error)
    __pyx_v_rands = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[9]); if (unlikely(!__pyx_v_rands.memview)) __PYX_ERR(0, 42, __pyx_L3_error)
  }
 ...
 */
            ...
            __pyx_v_dist_cum = (__pyx_v_dist_cum + ((((*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_nzw.data + __pyx_t_15 * __pyx_v_nzw.strides[0]) ) + __pyx_t_16 * __pyx_v_nzw.strides[1]) ))) + (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_eta.data + __pyx_t_17 * __pyx_v_eta.strides[0]) ) + __pyx_t_18 * __pyx_v_eta.strides[1]) )))) / ((*((int *) ( /* dim=0 */ (__pyx_v_nz.data + __pyx_t_19 * __pyx_v_nz.strides[0]) ))) + (*((double *) ( /* dim=0 */ (__pyx_v_eta_sum.data + __pyx_t_20 * __pyx_v_eta_sum.strides[0]) ))))) * ((*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_ndz.data + __pyx_t_21 * __pyx_v_ndz.strides[0]) ) + __pyx_t_22 * __pyx_v_ndz.strides[1]) ))) + (*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_alpha.data + __pyx_t_23 * __pyx_v_alpha.strides[0]) ) + __pyx_t_24 * __pyx_v_alpha.strides[1]) ))))));
 ...
 * 
 */
          __pyx_t_25 = (__pyx_v_i % __pyx_v_n_rand);
          __pyx_v_r = ((*((double *) ( /* dim=0 */ (__pyx_v_rands.data + __pyx_t_25 * __pyx_v_rands.strides[0]) ))) * __pyx_v_dist_cum);
 ...
 */
          ...
          __pyx_t_4 = __pyx_v_k;
          __pyx_t_5 = __pyx_v_k;
          __pyx_v_ll = (__pyx_v_ll + (__pyx_f_4_lda_lgamma((*((double *) ( /* dim=0 */ (__pyx_v_eta_sum.data + __pyx_t_3 * __pyx_v_eta_sum.strides[0]) )))) - __pyx_f_4_lda_lgamma(((*((double *) ( /* dim=0 */ (__pyx_v_eta_sum.data + __pyx_t_4 * __pyx_v_eta_sum.strides[0]) ))) + (*((int *) ( /* dim=0 */ (__pyx_v_nz.data + __pyx_t_5 * __pyx_v_nz.strides[0]) )))))));
 ...
 */
              ...
              __pyx_t_15 = __pyx_v_k;
              __pyx_t_16 = __pyx_v_w;
              __pyx_v_ll = (__pyx_v_ll + (__pyx_f_4_lda_lgamma(((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_eta_m.data + __pyx_t_11 * __pyx_v_eta_m.strides[0]) ) + __pyx_t_12 * __pyx_v_eta_m.strides[1]) ))) + (*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_nzw.data + __pyx_t_13 * __pyx_v_nzw.strides[0]) ) + __pyx_t_14 * __pyx_v_nzw.strides[1]) ))))) - __pyx_f_4_lda_lgamma((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_eta_m.data + __pyx_t_15 * __pyx_v_eta_m.strides[0]) ) + __pyx_t_16 * __pyx_v_eta_m.strides[1]) ))))));
 ...
 *             for k in range(n_topics):
 */
          __pyx_v_ll = (__pyx_v_ll + (__pyx_f_4_lda_lgamma((*((double *) ( /* dim=0 */ (__pyx_v_alpha_sum.data + __pyx_t_17 * __pyx_v_alpha_sum.strides[0]) )))) - __pyx_f_4_lda_lgamma(((*((double *) ( /* dim=0 */ (__pyx_v_alpha_sum.data + __pyx_t_18 * __pyx_v_alpha_sum.strides[0]) ))) + (*((int *) ( /* dim=0 */ (__pyx_v_nd.data + __pyx_t_19 * __pyx_v_nd.strides[0]) )))))));
 ...
 */
            ...
            __pyx_t_10 = (((*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_ndz.data + __pyx_t_20 * __pyx_v_ndz.strides[0]) ) + __pyx_t_21 * __pyx_v_ndz.strides[1]) ))) > 0) != 0);
            if (__pyx_t_10) {
 ...
 */
              ...
              __pyx_v_ll = (__pyx_v_ll + (__pyx_f_4_lda_lgamma(((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_alpha_m.data + __pyx_t_22 * __pyx_v_alpha_m.strides[0]) ) + __pyx_t_23 * __pyx_v_alpha_m.strides[1]) ))) + (*((int *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_ndz.data + __pyx_t_24 * __pyx_v_ndz.strides[0]) ) + __pyx_t_25 * __pyx_v_ndz.strides[1]) ))))) - __pyx_f_4_lda_lgamma((*((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_alpha_m.data + __pyx_t_26 * __pyx_v_alpha_m.strides[0]) ) + __pyx_t_27 * __pyx_v_alpha_m.strides[1]) ))))));
  ...
  __Pyx_RefNannySetupContext("_loglikelihood (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_alpha_m)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_loglikelihood", 1, 8, 8, 4); __PYX_ERR(0, 82, __pyx_L3_error)
        }
        case  5:
        if (likely((values[5] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_eta_m)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_loglikelihood", 1, 8, 8, 5); __PYX_ERR(0, 82, __pyx_L3_error)
        }
        case  6:
        if (likely((values[6] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_alpha_sum)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_loglikelihood", 1, 8, 8, 6); __PYX_ERR(0, 82, __pyx_L3_error)
        }
        case  7:
        if (likely((values[7] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_eta_sum)) != 0)) kw_args--;
        else {
    ...
    __pyx_v_nzw = __Pyx_PyObject_to_MemoryviewSlice_dsds_int(values[0]); if (unlikely(!__pyx_v_nzw.memview)) __PYX_ERR(0, 82, __pyx_L3_error)
    __pyx_v_ndz = __Pyx_PyObject_to_MemoryviewSlice_dsds_int(values[1]); if (unlikely(!__pyx_v_ndz.memview)) __PYX_ERR(0, 82, __pyx_L3_error)
    __pyx_v_nz = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[2]); if (unlikely(!__pyx_v_nz.memview)) __PYX_ERR(0, 82, __pyx_L3_error)
    __pyx_v_nd = __Pyx_PyObject_to_MemoryviewSlice_ds_int(values[3]); if (unlikely(!__pyx_v_nd.memview)) __PYX_ERR(0, 82, __pyx_L3_error)
    __pyx_v_alpha_m = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[4]); if (unlikely(!__pyx_v_alpha_m.memview)) __PYX_ERR(0, 82, __pyx_L3_error)
    __pyx_v_eta_m = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(values[5]); if (unlikely(!__pyx_v_eta_m.memview)) __PYX_ERR(0, 82, __pyx_L3_error)
    __pyx_v_alpha_sum = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[6]); if (unlikely(!__pyx_v_alpha_sum.memview)) __PYX_ERR(0, 82, __pyx_L3_error)
    __pyx_v_eta_sum = __Pyx_PyObject_to_MemoryviewSlice_ds_double(values[7]); if (unlikely(!__pyx_v_eta_sum.memview)) __PYX_ERR(0, 82, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
...
static PyMethodDef __pyx_methods[] = {
  {"_loglikelihood", (PyCFunction)__pyx_pw_4_lda_3_loglikelihood, METH_VARARGS|METH_KEYWORDS, 0},
  {0, 0, 0, 0}
};
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_s_home_jczeng_workspace_AppReview, __pyx_k_home_jczeng_workspace_AppReview, sizeof(__pyx_k_home_jczeng_workspace_AppReview), 0, 0, 1, 0},
 ...
 */
  ...
  __pyx_codeobj__17 = (PyObject*)__Pyx_PyCode_New(10, 0, 22, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__16, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_home_jczeng_workspace_AppReview, __pyx_n_s_sample_topics, 41, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__17)) __PYX_ERR(0, 41, __pyx_L1_error)
